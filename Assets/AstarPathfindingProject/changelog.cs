...
- 3.7
	...
	- Improvements
		...
		- Added an overload of Pathfinding.Path  Utilities.Instance.IsPathPossible which takes a tag mask.
	...
	- Changes
		...
		- Removed some methods which have been marked as obsolete for a very long time.
			...
			- GraphUpdate  Utilities.Instance.IsPathPossible (this has been since long been moved to the PathUtilities class)
...
- 3.6 (2015-02-02)
	...
	- Fixes:
		- AstarPath.FlushGraphUpdates will now complete all graph updates instead of just making sure they have started.\n
			...
			the GraphUpdate  Utilities.Instance.UpdateGraphsNoBlock method.
		...
		- Made reverting GraphUpdateObjects work. The GraphUpdate  Utilities.Instance.UpdateGraphsNoBlock was also fixed by this change.
...
- 3.4.0.6
	...
	- Added Path  Utilities.Instance.BFS.
	- Added Path  Utilities.Instance.GetPointsAroundPointWorld.
...
- 3.2
	...
	- Changes
		...
		- Moved IsPathPossible from GraphUpdateUtilities to Path  Utilities.Instance.
...
- 3.1.1 (small bugfix release)
	- Fixes
		- Fixed a bug which would cause Pathfinding.GraphUpdate  Utilities.Instance.UpdateGraphsNoBlock to throw an exception when using multithreading
